<link rel="stylesheet" type="text/css" href="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/css/request.css?v=5">
...
<div class="wrap handle-wrap">
  ...
  <div class="repayment-schema" style="display: none;">
    <div class="schema-info aui-margin-t-10 aui-margin-b-15">
      ...
      <p class="schema-tip"><span>返回</span>Request页</p>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  ...
  $('.schema-tip').on('click', function(){
    window.location.href = '<?php echo getUrl('request', 'index', array(), false, WAP_OPERATOR_SITE_URL)?>';
  });
