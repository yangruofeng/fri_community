    ...
    <div class="container" style="width: 600px">
        <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <img id="show_company_icon" style="display: <?php echo $output['company_config']['company_icon']?'block':'none'?>;" src="<?php echo $output['company_config']['company_icon']?(UPYUN_SITE_URL.DS.'company'.DS.$output['company_config']['company_icon']):''?>">
                    <div id="company_icon">Upload</div>
