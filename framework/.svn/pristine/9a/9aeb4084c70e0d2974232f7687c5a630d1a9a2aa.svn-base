...
class branchToCashierTradingClass extends tradingClass {
    private $branch_id;
    private $cashier_user_id;
    private $amount;
    private $currency;

    public function __construct($branchId, $cashierUserId, $amount, $currency)
    {
    ...
    {
        return array(
            'trading_type' => "branch_to_cashier",
            'subject' => 'Branch Manager To Cashier',
