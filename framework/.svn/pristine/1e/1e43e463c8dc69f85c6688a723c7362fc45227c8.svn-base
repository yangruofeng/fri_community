                            ...
                            <td>
                                <div class="input-group">
                                    <span class="input-group-btn verify-state">
                                       ...
                                       <button type="button" class="btn btn-default" value="100">Pass</button>
                                       <button type="button" class="btn btn-default" value="20">Allot to co</button>
                                       <button type="button" class="btn btn-default" value="11">Close</button>
                                    </span>
                                </div>
                            </td>
                        </tr>
