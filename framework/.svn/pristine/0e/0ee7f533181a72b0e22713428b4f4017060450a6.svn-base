...
class memberLoginGestureApiDocument extends apiDocument
{
    public function __construct()
    {
        $this->name = "Member Gesture Login";
        $this->description = "member手势密码登录";
        $this->url = C("bank_api_url") . "/member.login.gesture.php";
