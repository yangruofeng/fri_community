...
<div class="page">
    ...
    <div class="register-div">
        <div class="basic-info">
            ...
            <div class="content">
                <form class="form-horizontal" id="form-change" action="<?php echo getUrl('member', 'verifyChangeTradePwd', array(), false, ENTRY_COUNTER_SITE_URL) ?>"
                      method="post">
                    ...
                    <div class="col-sm-6 form-group">
                        <label class="col-sm-5 control-label"><span class="required-options-xing">*</span><?php echo 'Old Trade Password'?></label>
                        <div class="col-sm-7">
                    ...
                    <div class="col-sm-6 form-group">
                        <label class="col-sm-5 control-label"><span class="required-options-xing">*</span><?php echo 'New Trade Password'?></label>
                        <div class="col-sm-7">
