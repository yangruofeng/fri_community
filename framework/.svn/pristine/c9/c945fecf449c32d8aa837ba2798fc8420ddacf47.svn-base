 ...
 * Time: 13:39
 */
class memberCertedResultApiDocument extends apiDocument
{
    ...
    public function __construct()
    {
        ...
        $this->url = C("bank_api_url") . "/member.certed.result.php";

        $this->parameters = array();
        $this->parameters[]= new apiParameter("member_id", "会员id", 1, true);
        $this->parameters[]= new apiParameter("type", "类型 1 身份证 2 户口本 3 护照 4 房产 5 汽车资产  6 工作证明 7 公务员（合在工作）8 担保人 9 土地 10 居住证  11 摩托车 12 家庭关系", 1, true);
