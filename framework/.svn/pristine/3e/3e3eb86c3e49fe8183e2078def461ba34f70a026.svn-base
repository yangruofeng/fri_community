...
class loanRepaymentTradingClass extends tradingClass {
    ...
    public function __construct($schemeInfo, $currency, $penalty = 0)
    {
    ...
    protected function getTradingDetail()
    {
        ...
        $total_amount = $this->scheme_info->receivable_principal + $this->scheme_info->receivable_interest + $this->scheme_info->receivable_operation_fee + $this->penalty;
