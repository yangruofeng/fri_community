            ...
            <form class="form-inline" id="frm_search_condition">
                <table  class="search-table">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-default" href="<?php echo getUrl('editor', 'addSystemHelp', array(), false, BACK_OFFICE_SITE_URL) ?>"><i class="fa fa-plus"></i>System Article</a>
                        </td>
                    </tr>
                </table>
            </form>
