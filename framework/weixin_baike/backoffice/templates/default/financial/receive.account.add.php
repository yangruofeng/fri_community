                ...
                <div class="col-sm-8">
                    <select name="bank_code" class="form-control">
                        <?php foreach ($output['bank_list'] as $key => $val){?>
                            <option value="<?php echo $val['bank_code']; ?>" <?php echo $_GET['bank_code'] == $val['uid'] ? 'selected' : ''?>><?php echo $val['bank_name'];?></option>
                        <?php }?>
                    </select>
                ...
                <div class="col-sm-8">
                    <?php foreach ($output['branch_list'] as $val) { ?>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="<?php echo $val['uid']?>" name="branch_id[]" <?php echo in_array($val['uid'],$_GET['branch_id']) ? 'checked' : ''?>>
