...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li>
                    <a href="<?php echo getUrl('loan', 'requestToPrepayment', array(), false, BACK_OFFICE_SITE_URL) ?>"><span>Schema</span></a>
                </li>
...
<!--                --><?php //} ?>
                ...
                <?php if ($detail['request_img']) { ?>
                    <tr>
                        ...
                        <td>
                            <a target="_blank" href="<?php echo $detail['request_img'] ?>">
                                <img style="max-height: 200px;max-width: 100%" src="<?php echo $detail['request_img'] ?>">
                            </a>
                        </td>
                    </tr>
                <?php } ?>
