    ...
    <div class="container">
        ...
        <form class="demoform" id="validIDForm" action="index.php?act=client&op=cerifycationConfirm" method="post">
            ...
            <table class="table">
                ...
                <tr>
                    <td>
                        <label for="" class="control-label">Relation Type</label>
                    </td>
                    <td>
                        <?php echo $extend_info['relation_type']; ?>
                    </td>
                </tr>

                <tr>
                    <td>
                        <label for="" class="control-label">Relation Name</label>
                    </td>
                    <td>
                        <?php echo $extend_info['relation_name']; ?>
                    </td>
                </tr>

                <tr>
                    <td>
                        <label for="" class="control-label">Relation Cert Type</label>
                    </td>
                    <td>
                        <?php echo $extend_info['relation_cert_type'] ?>
                    </td>
                </tr>

                <tr>
                    <td><label class="control-label">Relation Cert Sn</label></td>
                    <td>
                        <?php if( $info['verify_state'] == certStateEnum::PASS || $info['verify_state'] == certStateEnum::NOT_PASS ){ ?>
                            <span><?php echo $extend_info['relation_cert_sn']; ?></span>
                        <?php }else{ ?>
                            <div class="cerification-form">
                                <input type="text" class="form-control" name="relation_cert_sn" value="">
                ...
                <tr>
                    <td>
                        <label for="" class="control-label">Relation Phone</label>
                    </td>
                    <td>
                        <?php echo $extend_info['relation_phone'] ?>
                    </td>
                </tr>
...
<script>
    ...
    var validParam = {
        ...
        params: [{
            ...
            field: 'relation_cert_sn',
            rules: {
                required: true
            },
            messages: {
                required: 'Please input relation cert sn'
            }
        }]
    };
