    ...
    <div class="container" style="width: 600px;">
        <form class="form-horizontal" method="post">
            ...
            <div class="form-group role-select">
                ...
                <div class="col-sm-9">
                    <?php $user_position = my_json_decode($output['user_info']['user_position'])?>
                    <?php foreach ($output['user_position'] as $key => $val) { ?>
                        <label class="col-sm-4"><input type="checkbox" name="user_position[]" value="<?php echo $key ?>" <?php echo in_array($key, $user_position) ? 'checked' : '' ?>><?php echo ucwords(strtolower($val))?></label>
                    <?php }?>
                </div>
            </div>
            <div class="form-group role-select">
                            ...
                            <ul class="list-group">
                                <?php foreach($v_1 as $v_2){?>
                                    <li class="list-group-item col-sm-6">
                                        <input type="checkbox" name="auth_select[]"
                                               value="<?php echo $v_2 ?>" <?php echo in_array($v_2, $output['user_info']['back_office_auth']) ? 'checked' : '' ?>><?php echo L('auth_' . strtolower($v_2)) ?>
                                    </li>
                                <?php }?>
                            </ul>
                        </div>
                    ...
                    <?php foreach($output['auth_group_counter'] as $k_1=>$v_1){?>
                        <div style="font-size: 16px;margin-bottom: 5px" class="counter_auth_group clearfix">
                            ...
                            <ul class="list-group">
                                <?php foreach($v_1 as $v_2){?>
                                    <li class="list-group-item col-sm-6">
                                        <input type="checkbox" name="auth_select_counter[]" value="<?php echo $v_2?>" <?php echo in_array($v_2, $output['user_info']['counter_auth']) ? 'checked' : '' ?>><?php echo L('auth_counter_'.strtolower($v_2))?>
                                    </li>
                                <?php }?>
                            </ul>
                        </div>
