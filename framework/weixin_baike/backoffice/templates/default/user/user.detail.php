        ...
        <div class="client-detail-wrap clearfix">
            <dl class="account-basic clearfix">
                ...
                <p class="account-head">
                    <img src="<?php echo $output['user_info']['user_icon'] ? $output['user_info']['user_icon'] : ENTRY_DESKTOP_SITE_URL . DS . 'resource/img/default_avatar.jpg'?>" class="avatar-lg" alt="">
                </p>
                </dt>
                <dd class="pull-left margin-large-left margin-large-right">
                    ...
                    <p class="text-small">
                        <span class="show pull-left base-name marginright10">Role</span>:
                        <span class="marginleft10">
                            <?php
                            $role_arr = array();
                            foreach ($output['user_info']['role_arr'] as $role) {
                                $role_arr[] = $output['role_list'][$role]['role_name'];
                            }
                            echo implode('/ ',$role_arr);
                            ?>
                        </span>
                    </p>
                    <p class="text-small">
