...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/css/init.css?v=5">
  ...
  <script src="<?php echo WAP_OPERATOR_SITE_URL;?>/resource/script/common.js?v=3"></script>
