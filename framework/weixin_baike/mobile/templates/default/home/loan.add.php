...
<header class="top-header" id="header" style="display: <?php echo $_GET['source'] == 'app' ? 'none' : 'block';?>">
  ...
  <span class="right-btn" onclick="window.location.href='<?php echo getUrl('home', 'clientRequest', array('id'=>$output['client_id']), false, WAP_OPERATOR_SITE_URL)?>'"><i class="aui-iconfont aui-icon-plus"></i></span>
</header>
