 ...
 * Time: 17:50
 */
// member.login.fingerprint
class memberLoginFingerprintApiDocument extends apiDocument
{
    public function __construct()
    {
        $this->name = "Member Fingerprint Login";
        $this->description = "member指纹密码登录";
        $this->url = C("bank_api_url") . "/member.login.fingerprint.php";
