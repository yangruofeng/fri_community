 ...
 * Time: 11:01
 */
class memberCreateApiDocument extends apiDocument
{
    public function __construct()
    {
        $this->name = "Member Create";
        $this->description = "member创建";
        $this->url = C("bank_api_url") . "/member.create.php";
        ...
        $this->parameters[]= new apiParameter("sms_code", "短信验证码", '365214', true);
        $this->parameters[]= new apiParameter("alias_name", "json多语言名字", '{"en":"zhang san","zh_cn":"张三"}');
        $this->parameters[]= new apiParameter("is_staff", "是否内部员工", 0);
        $this->parameters[]= new apiParameter("gender", "性别", 'male');
        $this->parameters[]= new apiParameter("civil_status", "婚姻状况", 'single');
        $this->parameters[]= new apiParameter("birthday", "生日", '1900-08-01');
        $this->parameters[]= new apiParameter("email", "邮箱", 'test@test.com');
